...
class RC(int, Enum):
    ...
    SCHED_FAIL_FINALIZE_STMT = 30
    SCHED_FAIL_RESET_STMT = 31
    SCHED_FAIL_OPEN_SCHED_FILE = 32
    SCHED_FAIL_CLOSE_SCHED_FILE = 33
    SCHED_SQLITE8_NOT_THREAD_SAFE = 29
    SCHED_SQLITE8_TOO_OLD = 30
    SCHED_FAIL_BEGIN_TRANSACTION = 36
    SCHED_FAIL_END_TRANSACTION = 37
    SCHED_FAIL_ROLLBACK_TRANSACTION = 38
